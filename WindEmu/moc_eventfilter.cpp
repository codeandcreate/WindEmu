...
QT_MOC_LITERAL(1, 12, 7), // "suspend"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "EventFilter\0suspend\0"
};
...
void EventFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (EventFilter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventFilter::suspend)) {
                *result = 0;
                return;
            }
        }
